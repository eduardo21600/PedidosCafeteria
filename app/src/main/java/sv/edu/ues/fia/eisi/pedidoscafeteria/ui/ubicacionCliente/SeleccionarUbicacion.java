...
public class SeleccionarUbicacion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paraLlevar = (Button) findViewById(R.id.pasar_local);

        paraLlevar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent result = new Intent();
                result.putExtra("idUbicacion", 1);
                result.putExtra("direccion", "Pasaré por el");
